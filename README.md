...
Este proyecto fue desarrollado como parte del curso de Sistemas Distribuidos. Para contribuciones:
...
Este proyecto es de uso académico para la Universidad Tecnológica de la Mixteca.

## 📞 Contacto

Para preguntas o soporte, contactar a cualquier miembro del equipo de desarrollo.

---

**Fecha de Desarrollo**: 4-8 de Agosto, 2025  
